...
/**
 * Configuration properties class for cas.mfa. Modified from baseline to support PushMfa.
 *
...
public class MultifactorAuthenticationProperties implements Serializable {
    ...
    //LOCAL CHANGE TO BASELINE START
    /**
     * Activate and configure a push multifactor authentication provider via Google Authenticator.
     */
    @NestedConfigurationProperty
    private PushMfaProperties pushMfa = new PushMfaProperties();
    public PushMfaProperties getPush() {
        return pushMfa;
    }
    public void setPush(final PushMfaProperties pushMfa) {
        this.pushMfa = pushMfa;
    }
    //LOCAL CHANGE TO BASELINE STOP
